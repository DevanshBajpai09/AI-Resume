// controller for enhancing the resumes
    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are expert in resume writing.Your task is to enhance the professional summary of a resume. The summmary should be 1-2 sentences also higlighting key skills, experience, and career objectives. Make it compelling and ATS-friendly. and only return text no options or anything else"
                },
                {
                    role: "user",
                    content: userContent,
...
// controller for eenhancing job descrpition
...
// controller for upload resume to thte database

                ...
                <main className="col-span-2 p-8 pt-0">
                    ...
                    {data.professional_summary && (
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-700 leading-relaxed break-words whitespace-pre-wrap">
                                {data.professional_summary}
                            </p>
                        </section>
                    )}
                            ...
                            <div className="space-y-6 mb-8">
                                {data.experience.map((exp, index) => (
                                    <div key={index}>
                                        ...
                                        {exp.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700 leading-relaxed break-words whitespace-pre-wrap space-y-1">

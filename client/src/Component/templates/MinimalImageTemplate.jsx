            ...
            <div className="space-y-6">
              {data.experience.map((exp, index) => (
                <div key={index}>
                  ...
                  {exp.description && (
                    <ul className="list-disc list-inside text-sm text-zinc-700 whitespace-pre-wrap space-y-1">
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white text-zinc-800">
      <div className="grid grid-cols-3">
        ...
        {/* LEFT SIDEBAR → education & skills draggable */}
        ...
        {/* RIGHT CONTENT → summary, experience, projects draggable */}

			...
			<div className="p-8">
				...
				{data.professional_summary && (
					<section className="mb-8">
						...
						<p className="text-gray-700 break-words whitespace-pre-wrap">{data.professional_summary}</p>
					</section>
				)}
						...
						<div className="space-y-6">
							{data.experience.map((exp, index) => (
								<div key={index} className="relative pl-6 border-l border-gray-200">
									...
									{exp.description && (
										<div className="text-gray-700 leading-relaxed mt-3 whitespace-pre-line break-words whitespace-pre-wrap">
											{exp.description}
										</div>
									)}
								</div>

...
const ColorPicker = ({ onChange, selectedColor }) => {
    ...
    return (
        <div className='relative'>
            <button onClick={() => setisOpen(!isOpen)} className='flex items-center gap-1 text-sm text-purple-600 bg-linear-to-br from-purple-50 to-purple-50 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
